...
#counts<- table(lmusic_df$`singer gender`, lmusic_df$genre)
#counts
...
#ggplot() +
 # geom_bar(aes(y = counts, x = genre, fill = counts), data = lmusic_df, stat="identity") +
#  scale_fill_manual(values=c("FF00CC", "#3300FF", "#9900FF"))
